    ...
    return (
        <div className={style.main_content_container}>
            ...
            <p className={style.main_content_container__text}>
                Tentarei ler o seu feedback o mais rápido possível e usá-lo para
                pensar nos pontos fortes e fracos das nossas aulas. Para voltar
                a tela inicial basta clicar no botão abaixo.
            </p>
